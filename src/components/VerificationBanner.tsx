      ...
      <div className="flex items-center gap-3 flex-1">
        ...
        <div>
          ...
          <p className="text-xs text-blue-300">
            You can send and receive new encrypted messages. To read old message history, verify this session in Element: Settings → Security & Privacy → Verify this session.
          </p>
        </div>
      </div>
      <button
